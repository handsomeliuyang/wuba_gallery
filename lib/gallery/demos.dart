...
const GalleryDemoCategory _kWuba = GalleryDemoCategory._(
    name: 'Wuba',
...
List<GalleryDemo> _buildGalleryDemos() {
  final List<GalleryDemo> galleryDemos = <GalleryDemo>[
    ...
    GalleryDemo(
      title: 'home',
      subtitle: 'wuba home demo',
      icon: GalleryIcons.switches,
      category: _kWuba,
      routeName: HomeDemo.routeName,
      buildRoute: (BuildContext context) => const HomeDemo(),
    )
  ];
